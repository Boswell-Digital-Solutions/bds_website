...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/BDSSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/BDSSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/BDSSYSTEM.md\`" "assembled primary output"
